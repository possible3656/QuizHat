...
public class SubscriptionAdapter extends RecyclerView.Adapter<SubscriptionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.txt_course.setText("Course Subscription");
        holder.text_amount.setText("Amount :- ₹" + String.valueOf(list1.get(position).getDiscountPrice()));
        holder.text_tensure.setText("Tensure :- " + String.valueOf(list1.get(position).getTenure()) + "days");
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            layout_buy_test.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    txt_course.setText("Course Subscription");
